...
<form method="post" action="/Java4_Demo_war_exploded/chi-tiet-san-pham/store">
    ...
    <div class="mb-3">
        ...
        <input type="number" class="form-control" id="exampleInputGN" required name="giaNhap">
    </div>
    <div class="mb-3">
        <label for="exampleInputGB" class="form-label">Giá Bán:</label>
        <input type="number" class="form-control" id="exampleInputGB" required name="giaBan">
    </div>
    <div class="mb-3">
        <label for="exampleInputMT" class="form-label">Mô Tả:</label>
        <input type="text" class="form-control" id="exampleInputMT" required name="moTa">
    </div>
