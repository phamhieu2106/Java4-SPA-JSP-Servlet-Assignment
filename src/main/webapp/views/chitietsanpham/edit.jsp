...
<h1 class="text-center">Cập Nhập Tiết Sản Phẩm</h1>
    ...
    <div class="mb-3">
        ...
        <select class="form-select" aria-label="Default select example" required name="nhaSanXuat">
            <c:forEach var="nsx" items="${listNhaSanXuat}">
                <option ${data.nhaSanXuat.id.equals(nsx.id) ? "selected" : ""} value="${nsx.id}">${nsx.ten}</option>
            </c:forEach>
        </select>
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <select class="form-select" aria-label="Default select example" required name="dongSanPham">
            <c:forEach var="dsp" items="${listDongSanPham}">
                <option ${data.dongSanPham.id.equals(dsp.id) ? "selected" : ""} value="${dsp.id}">${dsp.ten}</option>
            </c:forEach>
        </select>
    </div>
