...
<h1 class="text-center">Danh Sách Các Chức Vụ</h1>
<div class="col col-md-8">
    <form action="http://localhost:8080/Java4_Demo_war_exploded/chuc-vu/search?maSearch=${maSearch}" method="get">
        <div class="mb-3">
...
<table class="table">
    ...
    <c:forEach var="chucVu" items="${chucVuList}">
        <tr>
            ...
            <td>${chucVu.ten}</td>
            <td>
                <a href="/Java4_Demo_war_exploded/chuc-vu/edit?id=${chucVu.id}">
                    <button class="btn btn-primary">Update</button>
                </a>
                <a href="/Java4_Demo_war_exploded/chuc-vu/delete?id=${chucVu.id}">
...
<div class="text-center">
    <a href="/Java4_Demo_war_exploded/chuc-vu/create">
