...
<div class="col col-md-8">
    <form action="http://localhost:8080/Java4_Demo_war_exploded/cua-hang/search?maSearch=${maSearch}" method="get">
        <div class="mb-3">
...
<table class="table">
    ...
    <c:forEach var="cuaHang" items="${cuaHangList}">
        <tr>
            ...
            <td>
                <a href="/Java4_Demo_war_exploded/cua-hang/edit?id=${cuaHang.id}">
                    <button class="btn btn-primary">Update</button>
                </a>
                <a href="/Java4_Demo_war_exploded/cua-hang/delete?id=${cuaHang.id}">
...
<div class="text-center">
    <a href="/Java4_Demo_war_exploded/cua-hang/create">
