...
<html>
<head>
    <title>Danh Sách Các Dòng Sản Phẩm</title>
...
<h1 class="text-center">Danh Sách Các Dòng Sản Phẩm</h1>
<table class="table">
    <thead>
    <tr>
        <th scope="col">#</th>
    ...
    <c:forEach var="dongSanPham" items="${dongSanPhamList}">
        <tr>
            <th scope="row">${dongSanPham.id}</th>
            <td>${dongSanPham.ma}</td>
            <td>${dongSanPham.ten}</td>
            <td>
                <a href="/Java4_Demo_war_exploded/dong-san-pham/edit?id=${dongSanPham.id}">
                    <button class="btn btn-primary">Update</button>
                </a>
                <a href="/Java4_Demo_war_exploded/dong-san-pham/delete?id=${dongSanPham.id}">
...
<div class="text-center">
    <a href="/Java4_Demo_war_exploded/dong-san-pham/create">
