...
<form method="post" action="/Java4_Demo_war_exploded/khach-hang/store">
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="exampleInputTenDem" required name="tenDem">
    </div>
    <div class="mb-3">
        <label for="exampleInputHo" class="form-label">Họ:</label>
        <input type="text" class="form-control" id="exampleInputHo" required name="ho">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="exampleInputSdt" required name="sdt">
    </div>
    <div class="mb-3">
