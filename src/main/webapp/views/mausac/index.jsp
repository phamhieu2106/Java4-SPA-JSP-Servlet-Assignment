...
<table class="table">
    ...
    <c:forEach var="mauSac" items="${mauSacList}">
        <tr>
            <th scope="row">${mauSac.id}</th>
            <td>${mauSac.ma}</td>
            <td>${mauSac.ten}</td>
            <td>
                <a href="/Java4_Demo_war_exploded/mau-sac/edit?id=${mauSac.id}">
                    <button class="btn btn-primary">Update</button>
                </a>
                <a href="/Java4_Demo_war_exploded/mau-sac/delete?id=${mauSac.id}">
...
<div class="text-center">
    <a href="/Java4_Demo_war_exploded/mau-sac/create">
