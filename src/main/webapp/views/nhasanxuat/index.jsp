...
<html>
<head>
    <title>Danh Sách Các Nhà Sản Xuất</title>
...
<h1 class="text-center">Danh Sách Các Nhà Sản Xuất</h1>
<table class="table">
    <thead>
    <tr>
        <th scope="col">#</th>
    ...
    <c:forEach var="nhaSanXuat" items="${nhaSanXuatList}">
        <tr>
            <th scope="row">${nhaSanXuat.id}</th>
            <td>${nhaSanXuat.ma}</td>
            <td>${nhaSanXuat.ten}</td>
            <td>
                <a href="/Java4_Demo_war_exploded/nha-san-xuat/edit?id=${nhaSanXuat.id}">
                    <button class="btn btn-primary">Update</button>
                </a>
                <a href="/Java4_Demo_war_exploded/nha-san-xuat/delete?id=${nhaSanXuat.id}">
...
<div class="text-center">
    <a href="/Java4_Demo_war_exploded/nha-san-xuat/create">
