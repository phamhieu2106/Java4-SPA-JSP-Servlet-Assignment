...
<div class="col col-md-8">
    <form action="http://localhost:8080/Java4_Demo_war_exploded/san-pham/search?maSearch=${maSearch}" method="get">
        <div class="mb-3">
...
<table class="table">
    ...
    <c:forEach var="sanPham" items="${sanPhamList}">
        <tr>
            ...
            <td>${sanPham.ten}</td>
            <td>
                <a href="/Java4_Demo_war_exploded/san-pham/edit?id=${sanPham.id}">
                    <button class="btn btn-primary">Update</button>
                </a>
                <a href="/Java4_Demo_war_exploded/san-pham/delete?id=${sanPham.id}">
...
<div class="text-center">
    <a href="/Java4_Demo_war_exploded/san-pham/create">
